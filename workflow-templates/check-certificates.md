...
```markdown
[![Check Certificates status](https://github.com/REPO_OWNER/REPO_NAME/workflows/Check%20Certificates/badge.svg)](https://github.com/REPO_OWNER/REPO_NAME/actions?workflow=Check+Certificates)
```
...
```adoc
image:https://github.com/{repository-owner}/{repository-name}/workflows/Check%20Certificates/badge.svg["Check Certificates status", link="https://github.com/{repository-owner}/{repository-name}/actions?workflow=Check+Certificates"]
```
