...
```markdown
[![Check ToC status](https://github.com/REPO_OWNER/REPO_NAME/workflows/Check%20ToC/badge.svg)](https://github.com/REPO_OWNER/REPO_NAME/actions?workflow=Check+ToC)
```
...
```adoc
image:https://github.com/{repository-owner}/{repository-name}/workflows/Check%20ToC/badge.svg["Check ToC status", link="https://github.com/{repository-owner}/{repository-name}/actions?workflow=Check+ToC"]
```
